 ...
 **/
@Component({ template: '' })
export class DepartementSearch1BaseComponent
  ...
  implements OnInit
{
   ...
   */
  keys = `nomDepartment,nombreEmplyoye,Categorie,description`
  /**
  ...
  columnHeaderi18n: any = {
    nomDepartment: $localize`:@@UID__fld_nomDepartment;departement;search-1:Nom Department`,

    nombreEmplyoye: $localize`:@@UID__fld_nombreEmplyoye;departement;search-1:Nombre Emplyoye`,

    categorie: $localize`:@@UID__fld_categorie;departement;search-1:Categorie`,

    description: $localize`:@@UID__fld_description;departement;search-1:Description`,
  }
  ...
  ngOnInit() {
    ...
    this.store.dispatch(fromDepartement.initAction({ ...this.params }))
    this.init()
    ...
    this.prefix = `${environment.prefix}_departement_search-1`
   ...
   */
  init() {
    this.store.dispatch(fromDepartement.searchAction({ ...this.params }))
  ...
  onSelectionChange() {
    this.store.dispatch(
      fromDepartement.rowsSelectionChangeAction({
        ...this.params,
  ...
  /**
   * Executes the Button-63307 action
   * @return {void}
   */
  doButton63307(): void {
    this.store.dispatch(
      fromDepartement.button63307Action({ ...this.getActionPayload() })
    )
  }
}
