 ...
 * Service that displays an item selected from a collection screen
 * This service is auto generated by `UI Studio` tool for a `button` component having the `view-item` template.
 *
 ...
 */
@Injectable()
export class Button66719Action extends Action {
  constructor() {
    super()
  }
}
